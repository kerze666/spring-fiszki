        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="letter" align="justify">
                    ...
                    <form:form action="${pageContext.request.contextPath}/checkanswer" method="post">
                        <h2 class="section-heading" align="center">${word.polski}</h2>
                        <p>
                            <input type="hidden" name="id" value="${word.id}" align="middle">
                            <input class="input" type="text" name="answer" align="middle">
                        </p>
                        <br>
                        <p>
                            <input class="btn btn-outline btn-xl page-scroll" type="submit" value="Zatwierdź odpowiedź" onkeydown="enter" align="middle">
                        </p>
                        <br>
                        <p>
                            <a href="${pageContext.request.contextPath}/testcard"
                               class="btn btn-outline btn-xl page-scroll">Wylosuj inną</a>
                        </p>
