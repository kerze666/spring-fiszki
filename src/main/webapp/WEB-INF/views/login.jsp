        ...
        <div id="wrapper">
            <div id="login" class="animate form">
                <form action="<%=request.getContextPath()%>/login" method="POST">
                    ...
                    <p>
                        <label for="password" class="youpasswd"> Twoje hasło </label>
                        <input class="input" id="password" name="password" required="required" type="password"
                               placeholder="hasło"/>
                    </p>
                    <p class="login button">
                        <input class="btn btn-outline btn-xl page-scroll" type="submit" value="Zaloguj się">
                    </p>

                        Nie masz konta?
                        <br>
                        <a href="${pageContext.request.contextPath}/registry"
                           class="btn btn-outline btn-xl page-scroll">Zarejestruj się!</a>
