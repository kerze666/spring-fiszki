...
<nav id="mainNav" class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            <a class="navbar-brand page-scroll" href="${pageContext.request.contextPath}/admin">Start</a>
        </div>
        ...
        <div id="wrapper">
            <div id="login" class="animate form">
                <form action="<%=request.getContextPath()%>/admin/adduser" method="POST">
                    ...
                    <p>
                        <label for="password" class="youpasswd"> Hasło</label>
                        <input class="input" id="password" name="password" required="required" type="password"
                               placeholder="hasło"/>
                    </p>

                    <p class="login button">
                        <input class="btn btn-outline btn-xl page-scroll" type="submit" value="Dodaj">
                    </p>
                </form>
            </div>
        </div>
