        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-8 text-right">
                    <div class="heading text-right"><p><br><br></p><font color="white">Witaj ${username} </font>
                        <form action="/logout">
    ...
    <div class="row vertical-center-row">
        <section class="main" id="projekt">
            <div class="container">
                <div class="row">
                    <hr class="light">
                    <p><font size="4" color="white">Panel Administratora</font></p>
                    <hr class="light">
                    <br><br>
                    <div class="dodaj col-lg-4 text-center"><a href="/admin/adduser"
                                                               class="btn btn-primary btn-default"><span
                            class="glyphicon glyphicon-plus"></span> Dodaj
                        użytkownika</a><br><br><br><br><br><br><br><br></div>
                    <div class="col-lg-8 text-right">
                        <div class="wrapp">
                            <c:forEach var="user" items="${userlist}">
                                <div class="category text-left"><font size="4" color="white">${user.id} | ${user.username}</font>
                                </div>
                                <div class="cat-button">
                                    <a href="#" class="btn btn-default btn-sm">edytuj</a>
                                    <form action="/admin/delete/${user.id}" method="post">
                                        <input class="btn btn-default btn-sm" type="submit" value="Usuń użytkownika">
                                    </form>
                                </div>
                                <hr class="light">
                            </c:forEach>
