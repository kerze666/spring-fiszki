    ...
    <div class="container">
        ...
        <div class="navbar-header">
            <a class="navbar-brand page-scroll"
               href="${pageContext.request.contextPath}/user">Start</a>
        </div>
        ...
        <div class="row">
            ...
            <div class="col-sm-6">
                <div class="letter" align="justify">
                    ...
                    <hr class="light">
                    <form action="${pageContext.request.contextPath}/user/testcategory">
                        <input hidden class="" type="text" name="idCat" value="${word.category.id}">
                        <input class="btn btn-outline btn-xl page-scroll" type="submit" value="Następna fiszka!" onkeydown="enter">
                    </form>
                    <br>
                    <a href="${pageContext.request.contextPath}/user" class="btn btn-outline btn-xl page-scroll" onkeydown="escape">Wybierz nową kategorię!</a>
                </div>
            </div>
            <div class="col-sm-3"></div>
            <div class="col-sm-12"></div>
